...
gulp.task('delete', function()
{
    del.sync(['public/assets/**/*', '!public/assets',
        '!public/assets/css', '!public/assets/css/.gitignore',
        '!public/assets/fonts', '!public/assets/fonts/.gitignore',
        '!public/assets/images', '!public/assets/images/.gitignore',
        '!public/assets/img', '!public/assets/img/.gitignore',
        '!public/assets/js', '!public/assets/js/.gitignore',
        '!public/assets/vendors', '!public/assets/vendors/.gitignore'
...
elixir(function (mix) {
    ...
    mix.copy(paths.html5sortable + 'html.sortable.min.js',  destVendors + 'html5sortable/html.sortable.min.js');
    ...
    mix.styles(
        [
            'fonts.css', 'bootstrap.min.css', 'font-awesome.min.css', 'frontend/custom.css'
        ], destCss + 'lib.css');
