...
class JoshController extends Controller {
	...
	*/
    ...
    public function showHome()
    {
		...
		$registered_user = count(User::where('approved',"1")->get());
		$total_order = count(Orders::All());
		$today_order = count(Orders::where('order_date', 'like', '%'.$today.'%')->get());
    	if(Sentinel::check()){

			return view('admin.index', compact('total_user', 'registered_user', 'total_order', 'today_order'));
		}
		else
