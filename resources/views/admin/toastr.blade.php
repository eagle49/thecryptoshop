            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="livicon" data-name="bell" data-c="#fff" data-hc="white" data-size="18" data-loop="true"></i> Toastr Notification
                    </h3>
                </div>
                    ...
                    <div class="portlet-body">
                                    ...
                                    <div class="checkbox-list">
                                        <label for="closeButton">
                                                        <span class="checker" id="uniform-closeButton">
                                                            <input id="closeButton" type="checkbox" value="checked" checked="" class="input-small custom-checkbox"> Close Button
                                                        </span>
                                        </label>
                                        <label for="addBehaviorOnToastClick">
                                                        <span class="checker" id="uniform-addBehaviorOnToastClick">
                                                            <input id="addBehaviorOnToastClick" type="checkbox" value="checked" class="input-small custom-checkbox">Add behavior on toast click
                                                        </span>
                                        </label>
                                        <label for="debugInfo">
                                                        <span class="checker" id="uniform-debugInfo">
                                                            <input id="debugInfo" type="checkbox" value="checked" class="input-small custom-checkbox"> Debug
                                                        </span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3 ">
                                <div class="form-group" id="toastTypeGroup">
                                    ...
                                    <div class="radio-list padding-right10">
                                        <label>
                                                        <span class="checked">
                                                            <input type="radio" name="toasts" class="custom-radio" value="success"
                                                                   checked=""></span> Success
                                        </label>
                                        <label>
                                                        <span>
                                                            <input type="radio" name="toasts" class="custom-radio" value="info"></span> Info
                                        </label>
                                        <label>
                                                        <span>
                                                            <input type="radio" name="toasts" class="custom-radio" value="warning"></span> Warning
                                        </label>
                                        <label>
                                                        <span>
                                                            <input type="radio" name="toasts" class="custom-radio" value="error"></span> Error
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group" id="positionGroup">
                                    ...
                                    <div class="radio-list">
                                        <label>
                                                        <span class="checked">
                                                            <input type="radio" class="custom-radio"  name="positions" value="toast-top-right"
                                                                   checked=""></span> Top Right
                                        </label>
                                        <label>
                                                        <span>
                                        ...
                                        <label>
                                                        <span>
                                                            <input type="radio" class="custom-radio"  name="positions" value="toast-top-left"></span> Top Left
                                        </label>
                                        <label>
                                                        <span>
                                                            <input type="radio" class="custom-radio"  name="positions"
                                        ...
                                        <label>
                                                        <span>
                                                            <input type="radio" class="custom-radio"  name="positions"
                                                                   value="toast-bottom-full-width"></span> Bottom Full Width
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <button type="button" class="btn btn-default btn-raised toastrshow" id="cleartoasts">
                                    Clear Toasts
                                </button>
                                <button type="button" class="btn btn-default btn-raised toastrshow" id="clearlasttoast">Clear Last Toast
                                </button>
                            </div>
                        </div>
                        <br/>
