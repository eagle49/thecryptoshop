            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="livicon" data-name="rocket" data-loop="true" data-color="#fff" data-hovercolor="white" data-size="16"></i> Advanced customized Modals
                    </h3>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-3 ">
                            ...
                            <br>
                            <button class="btn btn-raised btn-primary " data-toggle="modal" data-target="#modal-1">Fade in &amp; Scale</button>
                            <button class="btn btn-raised btn-primary " data-toggle="modal" data-target="#modal-2">Slide in (right)</button>
                            <button class="btn btn-raised btn-primary " data-toggle="modal" data-target="#modal-3">Slide in (bottom)</button>
                        </div>
                        <div class="col-md-3">
                            <h3>
                            ...
                            <button class="btn btn-raised btn-info " data-toggle="modal" data-target="#modal-8">3D Expand Open</button>
                            <button class="btn btn-raised btn-info " data-toggle="modal" data-target="#modal-9">3D Big Entrance</button>
                            <button class="btn btn-raised btn-info " data-toggle="modal" data-target="#modal-10">3D Expand Up</button>
                            <button class="btn btn-raised btn-info " data-toggle="modal" data-target="#modal-14">3D Bounce</button>
                            <button class="btn btn-raised btn-info " data-toggle="modal" data-target="#modal-15">3D Pulse</button>
                            <button class="btn btn-raised btn-info " data-toggle="modal" data-target="#modal-13">3D Tossing</button>
                        </div>
                        <div class="col-md-3">
                            <h3>
                            ...
                            <br>
                            <button class="btn btn-raised btn-warning " data-toggle="modal" data-target="#modal-4">Pulldown</button>
                            <button class="btn btn-raised btn-warning " data-toggle="modal" data-target="#modal-5">Floating</button>
                            <button class="btn btn-raised btn-warning " data-toggle="modal" data-target="#modal-6">Stretch Left</button>
                            <button class="btn btn-raised btn-warning " data-toggle="modal" data-target="#modal-7">Pull Up</button>
                            <button class="btn btn-raised btn-warning " data-toggle="modal" data-target="#modal-11">Stretch Right</button>
                        </div>
                        <div class="col-md-3">
                            <h3>
                            ...
                            <button class="btn btn-raised btn-primary md-trigger" data-toggle="modal" data-target="#modal-16">Primary</button>
                            <button class="btn btn-raised btn-info md-trigger" data-toggle="modal" data-target="#modal-17">Info</button>
                            <button class="btn btn-raised btn-success md-trigger" data-toggle="modal" data-target="#modal-18">Success</button>
                            <button class="btn btn-raised btn-danger md-trigger" data-toggle="modal" data-target="#modal-21">Danger</button>
                            <button class="btn btn-raised btn-default md-trigger" data-toggle="modal" data-target="#modal-19">Default</button>
                            <button class="btn btn-raised btn-warning md-trigger" data-toggle="modal" data-target="#modal-20">Warning</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="livicon" data-name="bell" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Extended Modals
                    </h3>
                                <span class="pull-right clickable">
                                    <i class="glyphicon glyphicon-chevron-up"></i>
                                </span>
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-hover table-striped table-bordered">
                        ...
                        <tr>
                            <td>Responsive</td>
                            <td>
                                <a class="btn btn-raised btn-success btn-large" data-toggle="modal" data-href="#responsive" href="#responsive">View Demo</a>
                            </td>
                        </tr>
                        <tr>
                            <td>Stackable</td>
                            <td>
                                <a class="btn btn-raised btn-primary btn-large" data-toggle="modal" data-href="#stack1" href="#stack1">View Demo</a>
                            </td>
                        </tr>
                        <tr>
                            <td>Ajax</td>
                            <td>
                                <a class="btn btn-raised btn-warning btn-large" data-toggle="modal" data-href="#ajax-modal" href="#ajax-modal">View Demo</a>
                            </td>
                        </tr>
                        <tr>
                            <td>Static Background with Animation</td>
                            <td>
                                <a class="btn btn-raised btn-danger btn-large" data-toggle="modal" data-href="#static" href="#static">View Demo</a>
                            </td>
                        </tr>
                        <tr>
                            <td>Full Width</td>
                            <td>
                                <a class="btn btn-raised btn-info btn-large" data-toggle="modal" data-href="#full-width" href="#full-width">View Demo</a>
                            </td>
                        </tr>
                        <tr>
                            <td>Long Modals</td>
                            <td>
                                <a class="btn btn-raised btn-default btn-large" data-toggle="modal" data-href="#long" href="#long">View Demo</a>
                            </td>
                        </tr>
                        </tbody>
                    </table>
