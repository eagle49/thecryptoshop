                                    ...
                                    <div id="rootwizard">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tab2" disabled="disabled">
                                                ...
                                                <div class="form-group {{ $errors->first('pic_legal', 'has-error') }}">
                                                    <label for="pic_legal" class="col-sm-2 control-label">Legal ID picture</label>
                                                    <div class="col-sm-10">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 200px;">
                                                                @if($user->pic_legal)
                                                                    <img src="{!! url('/').'/uploads/users/legal/'.$user->pic_legal !!}" alt="profile pic">
                                                                @else
                                                                    <img src="http://placehold.it/200x200" alt="profile pic">
                                                                @endif
                                                            </div>
                                                    ...
                                                    <span class="btn btn-default btn-file">
                                                        <span class="fileinput-new">Select image</span>
                                                        <span class="fileinput-exists">Change</span>
                                                        <input id="pic_legal" name="pic_legal" type="file"
                                                               class="form-control"/>
                                                    </span>
                                                                <a href="#" class="btn btn-default fileinput-exists" data-dismiss="fileinput" style="color: black !important;">Remove</a>
                                                            </div>
                                            ...
                                            <div class="tab-pane" id="tab4" disabled="disabled">
                                                ...
                                                <div class="form-group">
                                                    <label for="approve" class="col-sm-2 control-label"> Approve User😍</label>
                                                    <div class="col-sm-10">
                                                        <input id="approve" name="approve" type="checkbox" class="pos-rel p-l-30 custom-checkbox" value="1" @if($user->approved) checked="checked" @endif  >
                                                        <span>To Approve your account click the check box</span>
                                                    </div>
                                                </div>
                                            </div>
