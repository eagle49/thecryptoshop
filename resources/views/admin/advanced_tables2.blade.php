            ...
            <div class="panel panel-primary filterable">
                <div class="panel-heading clearfix  ">
                    <div class="panel-title pull-left">
                        <div class="caption">
                            <i class="livicon" data-name="camera" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Show / hide columns dynamically
                        </div>
                    </div>
                </div>
                <div class="panel-body table-responsive">
                    ...
                    <div class="btn-group" style="margin:10px 0;">
                        <button type="button" class="toggle-vis btn btn-default" data-column="0">First Name</button>
                        <button type="button" class="toggle-vis btn btn-default" data-column="1">Last Name</button>
                        <button type="button" class="toggle-vis btn btn-default" data-column="2">User Name</button>
                        <button type="button" class="toggle-vis btn btn-default" data-column="3">User E-mail</button>
