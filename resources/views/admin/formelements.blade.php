...
@section('content')
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <textarea placeholder="Write something here..." class="form-control resize_vertical " data-autogrow rows="3" cols="80"></textarea>
                            </div>
                            <!-- /.input group -->
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <textarea placeholder="Write something here..." class="span3 form-control scroll pd resize_vertical " data-autogrow rows="3" cols="80"></textarea>
                            </div>
                            <!-- /.input group -->
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="span4">
                                    <textarea placeholder="Write something here..." class="span3 form-control display-no resize_vertical" data-autogrow rows="3" cols="80"></textarea>
    ...
    <!-- date-range-picker -->
    <script src="{{ asset('assets/vendors/autogrow/js/jQuery-autogrow.min.js') }}"  type="text/javascript"></script>
