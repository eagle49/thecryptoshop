<ul id="menu" class="page-sidebar-menu">
    ...
    <!-- <li {!! (Request::is('admin') ? 'class="active"' : '') !!}>
        <a href="{{ route('dashboard1') }}">
            <i class="livicon" data-name="home" data-size="18" data-c="#418BCA" data-hc="#418BCA"
               data-loop="true"></i>
            <span class="title">Dashboard_original</span>
        </a>
    </li> -->
    ...
    <li {!! (Request::is('admin/settings') ? 'class="active"' : '') !!}>
        <a href="{{  URL::to('admin/settings') }}">
            <i class="livicon" data-name="gear" data-size="18" data-c="#67C5DF" data-hc="#67C5DF"
               data-loop="true"></i>
            General Settings
        </a>
    </li>
    ...
    <li {!! (Request::is('admin/orders') ? 'class="active"' : '') !!}>
        <a href="#">
            <i class="livicon" data-name="notebook" data-size="18" data-c="#67E3DC" data-hc="#67E3DC"
               data-loop="true"></i>
