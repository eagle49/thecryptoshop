...
@section('header_styles')
    <link href="{{ asset('assets/vendors/owl.carousel/css/owl.carousel.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('assets/vendors/owl.carousel/css/owl.theme.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('assets/vendors/owl.carousel/css/owl.transitions.css') }}" rel="stylesheet" type="text/css">
...
@section('footer_scripts')
    <script src="{{ asset('assets/vendors/owl.carousel/js/owl.carousel.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/js/pages/carousel.js') }}" ></script>
